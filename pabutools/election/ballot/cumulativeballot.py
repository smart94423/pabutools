from pabutools.election.ballot.ballot import FrozenBallot
...
class CumulativeBallot(CardinalBallot):
    ...
    total number of points allocated to the voter. It is a subclass of `pabutools.instance.profile.Ballot`.
    Attributes
    """
