...
def avg_ballot_length(instance: Instance, profile: Profile) -> Fraction:
...
def avg_ballot_cost(instance: Instance, profile: ApprovalProfile) -> Fraction:
    """average ballot cost in an approval profile"""
    return np.average([ballot_cost(ballot) for ballot in profile])


def median_ballot_cost(instance: Instance, profile: ApprovalProfile) -> Fraction:
    """median ballot cost in an approval profile"""
    return np.median([ballot_cost(ballot) for ballot in profile])


def avg_approval_score(instance: Instance, profile: ApprovalProfile) -> Fraction:
...
def median_approval_score(instance: Instance, profile: ApprovalProfile) -> Fraction:
...
def avg_total_score(instance: Instance, profile: CumulativeProfile | CardinalProfile) -> Fraction:
    """average score of all projects in the instance"""
    return np.average([profile.score(project) for project in instance])


def median_total_score(instance: Instance, profile: CumulativeProfile | CardinalProfile) -> Fraction:
