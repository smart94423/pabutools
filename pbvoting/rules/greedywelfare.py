...
from pbvoting.election.satisfaction import AdditiveSatisfaction, SatisfactionProfile, SatisfactionMeasure, \
...
def greedy_scheme_additive(instance: Instance,
    ...
    """
    if not resoluteness:
        return greedy_scheme(instance, profile, sat_profile, budget_allocation, tie_breaking, resoluteness)
