...
def cardinality_sat_func(
    instance: Instance, profile: Profile, ballot: ApprovalBallot, project: Project
) -> int:
...
class Relative_Cardinality_Sat(AdditiveSatisfaction):
    def __init__(self, instance: Instance, profile: Profile, ballot: ApprovalBallot):
        ...
        self.max_budget_allocation_card = self.compute_max_budget_allocation_card(
    ...
    def get_score(self, project: Project) -> Number:
        ...
        score = self.func(
            ...
            self.ballot,
            project,
            self.max_budget_allocation_card,
        )
        self.scores[project] = score
        return score
...
class Relative_Cost_Sat(AdditiveSatisfaction):
    def __init__(self, instance: Instance, profile: Profile, ballot: ApprovalBallot):
        ...
        self.max_budget_allocation_cost = self.compute_max_budget_allocation_cost(
            ballot, instance.budget_limit
        )
    ...
    def get_score(self, project: Project) -> Number:
        ...
        score = self.func(
            ...
            self.ballot,
            project,
            self.max_budget_allocation_cost,
        )
        self.scores[project] = score
        return score
...
def relative_cost_unbounded_sat_func(
    ...
    return frac(
        ...
        total_cost([p for p in ballot if p in ballot]),
    )
...
def additive_card_sat_func(
    instance: Instance, profile: Profile, ballot: CardinalBallot, project: Project
) -> Number:
